                ...
                <div class="row gy-2 gy-lg-4">
                    ...
                    <div class="col-lg-6 col-xl-3 col-md-6 footer-col">
                        <div class="brand-logo">
                            <img src="{{ asset('frontend_assets/images/logo/commercial-spaces.png') }}" alt="" style="max-width: 320px;">
                        </div>
                ...
                <div class="modal-body">
                    <form id="enquiryForm" novalidate>
                        ...
                        <div class="glass-field">
                            ...
                            <input type="email" class="glass-input" id="enqEmail" name="email"
                                placeholder="you@example.com" required>
                        </div>
                        <div class="glass-field">
                            <label for="enqPhone">Phone</label>
                            <input type="tel" class="glass-input" id="enqPhone" name="phone"
                                placeholder="+971 00 000 0000" required>
                        </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content rounded-4 border-0 shadow-lg">
      <div class="modal-header border-0 pb-0">
        <div>     
          <h5 class="modal-title font-title fw-semibold" style="font-size:1.4rem;">Schedule Your Personal Tour</h5>
        </div>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <p class="text-muted small mb-3">Unit: <strong id="modal-unit-name" class="text-dark">ICICI Bank – Joy Central</strong></p>
        ...
        <div class="rounded-3 p-3 mt-3 d-flex gap-2" style="background:rgba(197,168,128,.12);border:1px solid rgba(197,168,128,.25);">
          <i data-lucide="car" class="ic-md" style="color:var(--gold-dark);flex-shrink:0;margin-top:2px;"></i>
          <p class="mb-0 small" style="color:var(--ink-soft);">Complimentary cab pickup available from Cyber City & IGI Airport terminals. Advisor will call to confirm.</p>
        </div>
      </div>
      <div class="modal-footer border-0 pt-0">
        <button type="button" class="btn btn-link fw-semibold text-decoration-none text-muted" data-bs-dismiss="modal">Cancel</button>
