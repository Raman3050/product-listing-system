...
<head>
    ...
    <title>AIPL Project Commercial Spaces - Connecting Investors & Businesses</title>
    <?php include "header.php" ?>


<!-- HERO -->
<section class="hero" style="background-image: url('./images/aipl-banner.webp');">
...
<section class="brand-strip">
  <div class="container">
    ...
    <div class="brand-logo-row">
      <div class="brand-logo"><img src="./images/project-present-brands/Chaayos-tea.png" alt=""></div>
      <div class="brand-logo"><img src="./images/project-present-brands/hdfc-bank.png" alt=""></div>
      <div class="brand-logo"><img src="./images/project-present-brands/calvin_klein.png" alt=""></div>
      <div class="brand-logo"><img src="./images/project-present-brands/Benetton.png" alt=""></div>
      <div class="brand-logo"><img src="./images/project-present-brands/geetanjali.png" alt=""></div>
      <div class="brand-logo"><img src="./images/project-present-brands/rare-rabbit.png" alt=""></div>
      <div class="brand-logo"><img src="./images/project-present-brands/start-bucks.png" alt=""></div>
      ...
      <div class="cards-grid" id="cardsGrid">
        ...
        <div class="prop-card" data-cat="food">
          <div class="prop-media">
            <div class="top-row">
              ...
              <div>
                <img src="images/projects/aipl-projects/joy-central.png" alt="" srcset="">
              </div>
            </div>
          ...
          <div class="prop-body">
            ...
            <div class="card-actions">
              ...
              <a href="details-page.php" class="btn-view">View Details</a>
            </div>
          </div>
        </div>
        ...
        <div class="prop-card" data-cat="bank">
          <div class="prop-media">
            ...
            <div class="brand-plaque">
                <img src="./images/project-present-brands/hdfc-bank.png" alt="">
        ...
        <div class="prop-card" data-cat="retail">
          <div class="prop-media">
            ...
            <div class="brand-plaque">
                <img src="./images/project-present-brands/calvin_klein.png" alt="">
        ...
        <div class="prop-card" data-cat="retail">
          <div class="prop-media">
            ...
            <div class="brand-plaque">
                <img src="./images/project-present-brands/Benetton.png" alt="">
        ...
        <div class="prop-card" data-cat="lifestyle">
          <div class="prop-media">
            ...
            <div class="brand-plaque">
                <img src="./images/project-present-brands/geetanjali.png" alt="">
        ...
        <div class="prop-card" data-cat="retail">
          <div class="prop-media">
            ...
            <div class="brand-plaque">
                <img src="./images/project-present-brands/rare-rabbit.png" alt="">
